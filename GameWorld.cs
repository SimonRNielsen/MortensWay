...
namespace MortensWay
{
    public class GameWorld : Game, ILoadAssets
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.DrawString(gameFont, "Potions : " + playerMorten.PotionCount +"\nKeys: "+ playerMorten.KeyCount , new Vector2(10, 50), Color.Black, 0, Vector2.Zero, 2, SpriteEffects.None, 1);
